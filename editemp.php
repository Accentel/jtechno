...
//$msg=$rw['msg'];
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                        ...
                                        <label><input type="radio" name="maritalstatus" value="married" <?php if (strtolower($rw['maritalstatus']) == "married") {
                                                                                                                echo 'checked';
                                                                                                            } ?>>Married</label>
                                        <label><input type="radio" name="maritalstatus" value="unmarried" <?php if (strtolower($rw['maritalstatus']) == "unmarried") {
                                                                                                                echo 'checked';
                                                                                                            } ?>>Unmarried</label>
                                       ...
                                       <td align="right">PF No.</td><td>
										...
										<input type="file"   name="empfile" id="img1" class="form-control photo-upload" accept=".jpg, .jpeg, .png" /></td>
